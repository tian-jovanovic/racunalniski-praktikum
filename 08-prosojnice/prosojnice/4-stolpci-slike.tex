...
%	  \draw (B) circle (1.5pt);
%	  \coordinate (T') at ({-\td},{\tt});
%	  \draw[gray, thin] (T') arc[start angle=210, end angle=330, radius=2] node[down] {\scriptsize $m$};  
%	  \coordinate (T'') at ({\td},{\tt});
%	  \draw[gray, thin] (T'') arc[start angle=210, end angle=330, radius=2] node[down] {\scriptsize $n$};
%	  \coordinate [label=below right:{\scriptsize $C$}] (C) at (0,{-\t});
%	  \draw (C) circle (2pt);
%	  \draw[red, very thick] (0, -2) -- (0,2) node[up] {};
%	\end{columns}
%\end{frame}
